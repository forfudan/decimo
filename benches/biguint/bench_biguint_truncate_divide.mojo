"""Benchmarks for BigUInt truncate divide. Compares BigUInt and Python int."""
...
def main() raises:
    ...
    var toml_path = "bench_data/truncate_divide.toml"
    var log_file = open_log_file("benchmark_biguint_truncate_divide")
    print_header("Decimo BigUInt Truncate Division Benchmark", log_file)
    ...
    print_summary(
        "BigUInt Truncate Division Benchmark Summary",
        sf,
        "BigUInt",
        iterations,
        log_file,
