"""Benchmarks for BigUInt addition. Compares BigUInt and Python int."""
...
def main() raises:
    ...
    print_header("Decimo BigUInt Addition Benchmark", log_file)
    ...
    print_summary(
        "BigUInt Addition Benchmark Summary",
        sf,
        "BigUInt",
        iterations,
        log_file,
